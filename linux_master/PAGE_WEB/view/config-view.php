<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ 
  ...
  FROM ticket
  INNER JOIN administrador ON ticket.nombre_usuario = administrador.nombre_completo
  WHERE administrador.nombre_completo = '$nombre_completo'";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 animated flip">
                <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de LinuxMaster</h1>
