<?php if(!$_SESSION['nombre']==""&&!$_SESSION['tipo']==""){ 
        ...
        if(isset($_POST['name_complete_update']) && isset($_POST['old_user_update']) && isset($_POST['new_user_update']) && isset($_POST['old_pass_update']) && isset($_POST['new_pass_update'])){
          ...
          if(mysqli_num_rows($sql)>=1){
            ...
            // Código para mostrar la tabla de tickets
                  $nombre_completo = $_SESSION['nombre_completo'];
                  $query_tickets = "SELECT serie, fecha 
                  FROM ticket
                  INNER JOIN cliente ON ticket.nombre_usuario = cliente.nombre_completo
                  WHERE cliente.nombre_completo = '$nombre_completo'";
                  $result_tickets = Mysql::consulta($query_tickets);
        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de cuenta LinuxMaster</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de LinuxMaster</p>
            </div>
          </div><!--Fin row well-->
          
          <div class="row">
            <div class="col-sm-8">
            <h4>Tickets solicitados:</h4>
                <table class="table">
                    <thead>
                        <tr>
                            <th>Serie</th>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-7 animated flip">
                <h1 class="text-danger">Lo sentimos esta página es solamente para usuarios registrados en LinuxMaster</h1>
...
<script>
    $(document).ready(function(){
        $("#input_user").keyup(function(){
          $.ajax({
            url:"./controller/val.php?id="+$(this).val(),
